...
TRADEMARK: AquaScan Pro™ is a registered trademark of EmersonEIMS
PATENT PENDING: Groundwater AI prediction algorithms and methods
LICENSE: This report is generated exclusively by licensed AquaScan Pro™ software

This proprietary analysis uses NASA GLDAS, ESA Sentinel-2, USGS Landsat-8,
and Google Earth Engine data. Unauthorized reproduction of this software
or its methodologies is strictly prohibited.

Contact: +254 768 860 665 | legal@emersoneims.com
Website: https://www.emersoneims.com
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-600 -mx-6 -mt-6 px-6 py-6 mb-6 text-white">
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2 text-xs text-blue-100">
              <span className="bg-white/20 px-2 py-0.5 rounded">AquaScan Pro™</span>
              <span>|</span>
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <h2 className="text-2xl font-bold mt-1">AquaScan Pro™ Assessment Complete</h2>
