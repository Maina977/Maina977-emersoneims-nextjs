...
// Core Features
const CORE_FEATURES = [
  { icon: '🔍', stat: '2,900+', label: 'Fault Codes', desc: 'Comprehensive database' },
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative">
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-3xl mx-auto">
            ...
            <span className="text-amber-400 font-bold">2,900+ fault codes</span> across{' '}
        ...
        >
          {[
            { value: '2,900+', label: 'Fault Codes', color: '#06b6d4' },
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-green-500/20 via-emerald-500/30 to-green-500/20 border-2 border-green-500/50 rounded-3xl p-8 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-slate-300 max-w-2xl mx-auto">
                ...
                Full access to all features. All 2,900+ fault codes. AI diagnostics included. No credit card required.
              </p>
        ...
        >
          ...
          {/* WhatsApp Expert Help CTA */}
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center items-center">
            <a
              href="https://wa.me/254768860665?text=Hi%2C%20I%20need%20help%20with%20generator%20diagnostics"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-full transition-all hover:scale-105"
            >
              ...
              Need Expert Help? WhatsApp Us
            </a>
            <a
              href="tel:+254768860665"
              className="inline-flex items-center gap-2 px-6 py-3 bg-slate-700 hover:bg-slate-600 text-white font-semibold rounded-full transition-all hover:scale-105"
            >
