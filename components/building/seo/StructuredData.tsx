...
export function DiagnosticSuiteSchema() {
  const schema = {
    ...
    description: 'Professional generator diagnostic tool with 2,900+ error codes covering Cummins, Caterpillar, Perkins, DeepSea, PowerWizard and more. AI-powered fault analysis with step-by-step repair guides.',
    featureList: [
      '2,900+ Error Codes Database',
