...
export default function GeneratorOracleShowcase() {
  ...
  const liveStats = health.status === 'connected' && health.totals
    ...
    : [
        { value: '2,900+', label: 'Fault-code references', color: '#06b6d4' },
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative">
        ...
        >
          ...
          <p className="text-lg text-slate-400 max-w-3xl mx-auto">
            ...
            <span className="text-amber-400 font-bold">2,900+ fault-code references</span>,{' '}
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-green-500/20 via-emerald-500/30 to-green-500/20 border-2 border-green-500/50 rounded-3xl p-8 text-center">
            ...
            <div className="relative">
              ...
              <p className="text-slate-300 max-w-2xl mx-auto">
                Use Generator Oracle free for life — full access to 2,900+ fault-code references,
