...
const TOOLS: { href: string; name: string; tag: string; blurb: string }[] = [
  {
    ...
    blurb: 'Search 57,600+ verified fault codes, read interactive wiring diagrams, and run AI-guided troubleshooting for Cummins, Perkins, FG Wilson and every major controller (DSE, ComAp, PowerWizard).',
  },
  {
