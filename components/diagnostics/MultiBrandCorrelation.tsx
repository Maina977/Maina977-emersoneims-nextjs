        ...
        {correlation.correlatedCodes.map((corr, index) => (
          ...
          >
            <div className="flex items-start justify-between">
              ...
              {/* View Button */}
              <a
                href={`/generator-oracle?search=${encodeURIComponent(corr.code)}`}
                className="ml-4 px-4 py-2 bg-cyan-500/20 text-cyan-300 rounded-lg text-sm font-semibold hover:bg-cyan-500/30 transition opacity-0 group-hover:opacity-100"
              >
                View Details
              </a>
            </div>
