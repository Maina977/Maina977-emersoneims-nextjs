 ...
 * The component body is unchanged — renamed WhatsAppButtonInner and wrapped here.
 */
export default function WhatsAppButton(props: Parameters<typeof WhatsAppButtonInner>[0]) {
  return (
