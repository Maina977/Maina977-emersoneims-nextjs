...
const services = [
  {
    ...
    description: 'Premium diesel generators engineered for reliability, efficiency, and performance. From 10 kVA to 2000 kVA, we supply, install and service Cummins, VOLTKA and Perkins systems.',
