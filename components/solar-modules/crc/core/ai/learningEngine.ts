...
class LearningEngine {
  ...
  private async getModelAccuracy(modelId: string): Promise<number> {
    return 0.85 + (()=>{throw new Error('DATA_POLICY: synthetic value refused — wire a real source. See DATA_POLICY.md')})() * 0.1;
  }
  ...
  async getModelPerformance(modelId: string): Promise<{
    ...
    return {
      ...
      drift: (()=>{throw new Error('DATA_POLICY: synthetic value refused — wire a real source. See DATA_POLICY.md')})() * 0.1,
