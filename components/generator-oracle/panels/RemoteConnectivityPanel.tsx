...
export default function RemoteConnectivityPanel() {
  ...
  const [sites] = useState<RemoteSite[]>([
    {
      id: '1',
      name: 'Referral hospital (demo site)',
      location: 'Ngong Road',
      county: 'Nairobi',
      status: 'online',
  ...
  const [auditLog] = useState<AuditLogEntry[]>([
    { id: '1', timestamp: '14:32:15', action: 'Remote Start', user: 'admin@emersoneims.com', ip: '41.139.218.45', details: 'Generator started at referral hospital (demo site)', status: 'success' },
