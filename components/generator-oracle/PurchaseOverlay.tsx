...
const FEATURES = [
  {
    icon: '🔍',
    title: '3,800+ Fault-Code References',
            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-amber-500/50 rounded-2xl p-6 mb-6 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <ul className="space-y-2 mb-6">
                  {['Full access to all 3,800+ fault codes', 'Unlimited searches & diagnoses', 'Offline mobile app access', 'All future updates included'].map(item => (
