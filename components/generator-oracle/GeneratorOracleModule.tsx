...
export default function GeneratorOracleModule() {
  ...
  const handleSearch = useCallback(async (query: string) => {
    ...
    // Cancel any in-flight search so only the latest request resolves.
    ...
    try {
      ...
      // Slim API rows are mapped to ControllerFaultCode-shaped stubs so
      // existing consumers (FaultDiagnosticsPanel list, command-search list)
      // keep working. Detail panes that need the full record can call
      // lookupFaultCode(code) on click — no full dataset is required.
                ...
                {activeScreen === 'faults' && (
                  ...
                  >
                    ...
                    <div className="text-center mb-4">
                      ...
                      <p className="text-slate-400 text-sm">57,600+ Fault Codes, Deep Analysis & Interactive Troubleshooting</p>
                    </div>
