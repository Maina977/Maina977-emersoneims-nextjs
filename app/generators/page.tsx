...
import SectionLead from "../../app/componets/generators/SectionLead";
import GeneratorCalculator from "../../app/componets/generators/generatorscalculator";
import MTBFChart from "../../app/componets/generators/MTBFChart";
import ErrorFrequencyChart from "../../app/componets/generators/ErrorFrequencyChart";
          ...
          <div className="mt-12 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {cumminsGenerators.slice(0, 4).map((gen) => (
              <div key={gen.model} className="bg-gray-900/50 rounded-lg p-6 border border-gray-700 hover:border-brand-gold transition-colors">
                ...
                <a href="/generators/models" className="inline-block mt-4 text-brand-gold hover:text-yellow-400">
                  View Details →
                </a>
              </div>
            ))}
      ...
      <section id="services" className="py-16 bg-gradient-to-b from-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <a href="/generators/services" className="sci-fi-button">View All Services</a>
          </div>
        </div>
      </section>
    </main>
