...
// Common Issues
const commonIssues = [
  'Generator not starting', 'Low power output', 'Engine overheating', 'Excessive fuel consumption',
  'Black smoke emission', 'White smoke emission', 'Blue smoke emission', 'Oil leaks',
  'Coolant leaks', 'Fuel leaks', 'Battery not charging', 'Alternator failure',
  'AVR failure', 'Control panel faults', 'Voltage fluctuations', 'Frequency instability',
  'Engine knocking', 'Turbocharger failure', 'Injector problems', 'Governor issues',
  'Starter motor failure', 'Glow plug failure', 'Fuel pump failure', 'Water in fuel',
  'Clogged filters', 'Belt failures', 'Radiator blockage', 'Thermostat failure',
  'Head gasket failure', 'Crankshaft damage', 'Piston ring wear', 'Bearing failure',
];
...
export default function GeneratorMaintenancePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="tel:+254768860655" className="px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg transition-all flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {servicePackages.map((pkg, i) => (
              <div key={i} className={`rounded-2xl p-6 border ${i === 3 ? 'bg-gradient-to-br from-orange-900/30 to-orange-800/10 border-orange-500/30' : 'bg-gray-900/50 border-gray-800'}`}>
                ...
                <a href="tel:+254768860655" className="mt-6 block w-full py-3 text-center bg-orange-500 hover:bg-orange-600 rounded-lg font-medium transition-colors">
                  Book Now
                </a>
              </div>
            ))}
      ...
      <section className="py-20 bg-black/50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-12">Common Generator Issues We Fix</h2>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
            {commonIssues.map((issue, i) => (
              <div key={i} className="px-4 py-3 bg-gray-900/50 rounded-lg border border-gray-800 text-sm text-gray-300 hover:border-orange-500/30 hover:text-orange-300 transition-colors cursor-pointer">
                {issue}
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-orange-700">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="tel:+254768860655" className="px-8 py-4 bg-white text-orange-600 font-bold rounded-lg text-lg hover:bg-gray-100 transition-colors">
              📞 Call: 0768 860 655
            </a>
