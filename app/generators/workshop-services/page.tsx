        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {[
              ...
              { href: '/services/motor-rewinding', label: 'Motor rewinding' },
              { href: '/solutions/diesel-automation', label: 'Diesel automation' },
              { href: '/fabrication', label: 'Steel fabrication' },
              { href: '/services/borehole-pumps', label: 'Borehole & pump services' },
              { href: '/services/ats-changeover', label: 'ATS & changeover systems' },
