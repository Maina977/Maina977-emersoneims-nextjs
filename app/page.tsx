  ...
  const products = [
    {
      ...
      description: 'AI-assisted diagnostic assistant that analyses generator symptoms, looks them up against a 57,600+ fault-code database, and connects you with certified technicians.',
