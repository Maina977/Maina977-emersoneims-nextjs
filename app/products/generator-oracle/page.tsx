        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 mb-4">3,800+ fault codes with detailed explanations and repair guides.</p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Africa's #1 generator diagnostic platform with 3,800+ fault codes, AI-powered diagnosis, and step-by-step repair guides.",
            "provider": {
              "@type": "Organization",
              "name": "EmersonEIMS",
