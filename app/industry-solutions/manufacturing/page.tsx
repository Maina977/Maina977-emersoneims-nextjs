...
export const metadata: Metadata = {
   ...
   * is now the declared canonical for the set. It is the longest of the three at 1,363 words.
   *
   ...
   */
  alternates: { canonical: 'https://www.emersoneims.com/industries/manufacturing-industries' },
