...
const CONTENT_PARAGRAPHS = [
  "EmersonEIMS Solutions represents the culmination of over 12 years of engineering excellence since 2013 in East Africa's energy infrastructure sector. Our comprehensive solutions portfolio spans diesel generators, solar energy systems, power quality management, automation, and critical infrastructure maintenance. With verified expertise across all 47 Kenyan counties, we've successfully delivered 500+ projects, achieving an industry-leading 98.7% system uptime. Every project meets international standards while addressing Kenya's unique power challenges.",
  "Our diesel generator solutions encompass the complete power generation lifecycle, from initial load analysis and system design to installation, commissioning, and 24/7 maintenance support. As authorized Cummins Voltka partners, we specialize in Cummins and Perkins generators ranging from compact 20kVA units for residential backup to industrial 2000kVA systems powering data centers and manufacturing facilities. Each installation includes advanced control systems featuring DeepSea DSE 7320 automation, enabling remote SMS/GPRS monitoring, automatic mains failure detection, and predictive maintenance alerts. Our verified track record includes St. Austin Academy (50 KVA), Kivukoni International School (60 KVA), Bigot Flowers (300+100 KVA), Afriherbs Limited (300 KVA), AMH (200 KVA), Maua Methodist Hospital (200 KVA), FAO Somalia (100 KVA), and Takaungu Regeneration (44 KVA).",
  "Solar energy solutions form a cornerstone of our renewable energy portfolio, with expertise spanning 5kW residential rooftop installations to 500kW commercial solar farms and hybrid solar-diesel systems delivering 24/7 uptime. Our solar technical team addresses Kenya-specific challenges including KPLC net-metering configurations, battery storage integration (lithium-ion vs lead-acid ROI analysis), inverter optimization for unstable grid conditions, and off-grid system design for rural electrification. We leverage Tier-1 panel technology combined with Victron Energy and SMA inverters for maximum reliability. Our solar sizing methodology incorporates Kenya's exceptional 5.5-5.9 kWh/m²/day solar irradiance (Nairobi: 5.7, Mombasa: 5.9, Kisumu: 5.5), achieving 18-35% ROI and typical payback periods of 3.2-4.5 years depending on KPLC tariff category.",
  ...
  "The future of energy infrastructure in East Africa demands integrated solutions that combine 99.9% reliability, carbon footprint reduction, and AI-powered intelligent management. EmersonEIMS Solutions bridges this gap through our comprehensive service ecosystem: Cummins Voltka-certified technicians, 24/7/365 emergency hotline (+254 727 631 316), mobile diagnostic units in Nairobi/Mombasa/Kisumu, and cloud-based SCADA monitoring platforms. Our commitment extends beyond installation to lifetime partnerships, with Annual Maintenance Contracts (AMC) and guaranteed response times. As Kenya transitions toward Vision 2030's 100% clean energy goal, our solutions portfolio evolves to incorporate lithium-ion battery storage, smart microgrids with load-shedding automation, and IoT-enabled predictive maintenance, positioning EmersonEIMS as East Africa's definitive engineering partner for the energy sector."
];
