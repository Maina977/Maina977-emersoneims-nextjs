...
const SOLAR_FAQ = [
  ...
  { id: 11, category: 'Cost', question: 'Are there solar financing options in Kenya?', answer: 'Yes! Options include: 1) Bank loans (most commercial banks offer green energy products), 2) Saccos with lower rates, 3) Pay-as-you-go solar providers, 4) Asset financing companies, 5) Some installers offer in-house financing. Interest rates range 12-18% p.a. Many systems pay for themselves within the loan period.' },
        ...
        <AnimatePresence mode="wait">
          ...
          {activeSection === 'calculator' && (
            <motion.div
              ...
              className="space-y-6"
            >
              {/* World's Most Advanced Solar Calculator */}
              <SolarBibleEngine />
            </motion.div>
          )}
