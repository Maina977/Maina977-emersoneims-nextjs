...
/*
 * Metadata for /maintenance-hub/general.
 *
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.emersoneims.com/maintenance-hub/general' },
  title: 'Industrial Maintenance Services A-Z',
  description:
    'An A-Z of industrial maintenance in Kenya: what each service covers, how often it is needed, and how to tell planned maintenance from a real fault.',
};
