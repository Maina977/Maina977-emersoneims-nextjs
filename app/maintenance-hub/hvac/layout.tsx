...
/*
 * Metadata for /maintenance-hub/hvac.
 *
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.emersoneims.com/maintenance-hub/hvac' },
  title: 'HVAC, Refrigeration & AC Maintenance',
  description:
    'HVAC and refrigeration maintenance in Kenya: cooling load, filter and coil servicing, refrigerant handling, and why AC units fail in this climate.',
};
