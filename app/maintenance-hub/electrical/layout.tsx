...
/*
 * Metadata for /maintenance-hub/electrical.
 *
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.emersoneims.com/maintenance-hub/electrical' },
  title: 'Electrical Installation & Maintenance',
  description:
    'Electrical installation, testing and maintenance in Kenya: distribution boards, earthing, cable sizing, protection coordination and planned inspection.',
};
