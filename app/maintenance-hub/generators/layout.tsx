...
/*
 * Metadata for /maintenance-hub/generators.
 *
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.emersoneims.com/maintenance-hub/generators' },
  title: 'Generator Engine Room Diagnostics',
  description:
    'Engine room diagnostic reference for generator faults — search fault codes by brand and controller, with likely causes and what to check first.',
};
