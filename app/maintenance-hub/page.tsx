...
const SERVICES = [
  {
    ...
    icon: '⚡',
    description: 'A detailed generator diagnostic platform with 57,600+ verified fault codes, AI-powered diagnostics, and expert repair guides for all major controller brands.',
        ...
        >
          <div>
            ...
            <p className="text-slate-400 text-lg">
              Multi-Discipline Maintenance Hub • 57,600+ Fault Codes • All 47 Kenya Counties
            </p>
          </div>
