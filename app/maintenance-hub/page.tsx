...
const SERVICES = [
  {
    ...
    icon: '⚡',
    description: 'A detailed generator diagnostic platform with 6,700+ verified fault codes, AI-powered diagnostics, and expert repair guides for all major controller brands.',
        ...
        >
          <div>
            ...
            <p className="text-slate-400 text-lg">
              Multi-Discipline Maintenance Hub • 6,700+ Fault Codes • All 47 Kenya Counties
            </p>
          </div>
