...
const SERVICES = [
  {
    ...
    icon: '⚡',
    description: 'A detailed generator diagnostic platform with manufacturer-curated fault codes, AI-powered diagnostics, and expert repair guides for all major controller brands.',
  ...
  },
  {
    ...
    features: ['Rewinding Guide', 'VFD/Inverters', 'Fault Codes', 'Repair Manuals'],
  },
  {
    id: 'hvac',
    name: 'HVAC Bible',
    icon: '❄️',
    description: 'Complete AC & refrigeration guide with 200+ fault codes, BTU calculator, cold room design, and repair manuals for all major brands.',
    href: '/maintenance-hub/hvac',
    stats: { value: '200+', label: 'Fault Codes' },
    color: 'blue',
    glowColor: 'rgba(59, 130, 246, 0.5)',
    features: ['BTU Calculator', 'Fault Codes', 'Cold Rooms', 'Repair Manuals'],
  },
  {
    id: 'electrical',
    ...
    features: ['KPLC Standards', 'Wiring Diagrams', 'Load Calculator', 'Earthing Guide'],
  },
  {
    id: 'borehole',
    name: 'Borehole & Pumps Bible',
    icon: '💧',
    description: 'Complete borehole and pump guide with 200+ fault codes, aquifer data for all 47 counties, pump sizing calculator, and repair manuals.',
    href: '/maintenance-hub/borehole',
    stats: { value: '200+', label: 'Fault Codes' },
    color: 'teal',
    glowColor: 'rgba(20, 184, 166, 0.5)',
    features: ['Aquifer Maps', 'Pump Sizing', 'Fault Codes', 'Repair Manuals'],
  },
  {
    id: 'welding',
    name: 'Welding Bible',
    icon: '🔥',
    description: 'Professional welding guide with 100+ welding procedures, defect identification, parameter calculator, and fabrication standards.',
    href: '/maintenance-hub/welding',
    stats: { value: '100+', label: 'Procedures' },
    color: 'red',
    glowColor: 'rgba(239, 68, 68, 0.5)',
    features: ['WPS Database', 'Defect Guide', 'Parameter Calc', 'Fabrication'],
  },
  {
    id: 'plumbing',
    name: 'Plumbing Bible',
  ...
  {
    id: 'incinerators',
    name: 'Incinerator Bible',
    icon: '🔥',
    description: 'Complete incinerator guide with 100+ fault codes, NEMA emissions standards, medical/industrial/agricultural waste management.',
    href: '/maintenance-hub/incinerators',
    stats: { value: '100+', label: 'Fault Codes' },
    color: 'orange',
    glowColor: 'rgba(249, 115, 22, 0.5)',
    features: ['Medical Waste', 'NEMA Standards', 'Emissions Control', 'Maintenance'],
  },
  {
    id: 'fabrication',
    name: 'Fabrication Bible',
    icon: '🏭',
    description: 'Complete fabrication guide for generator exhausts, canopies, fuel tanks with automation, enclosures, and main distribution boards.',
    href: '/maintenance-hub/fabrication',
    stats: { value: '50+', label: 'Specifications' },
    color: 'slate',
    glowColor: 'rgba(148, 163, 184, 0.5)',
    features: ['Exhausts', 'Canopies', 'Fuel Tanks', 'MDB Panels'],
  },
];
...
const SystemStatusPanel = () => {
  const [systemStats, setSystemStats] = useState({
    uptime: '99.97%',
    activeServices: 9,
    faultCodes: 231500, // 230K generators + 350 solar + 200 motors + 200 hvac + 200 electrical + 200 pumps + 100 welding + 150 plumbing
    lastUpdate: new Date(),
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-cyan-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <div>
            ...
            <p className="text-slate-400 text-lg">
              Multi-Discipline Maintenance Hub • Curated Fault Codes • All 47 Kenya Counties
            </p>
          </div>
        ...
        >
          {[
            { value: '231,500+', label: 'Fault Codes Database', color: 'cyan' },
            { value: '47', label: 'Counties Covered', color: 'green' },
            { value: '9', label: 'Comprehensive Bibles', color: 'amber' },
