...
const GeneratorCore = lazy(() => import('@/components/webgl/GeneratorCore'));
const BrandStorytelling = lazy(() => import('@/components/storytelling/BrandStorytelling'));
const NikeStyleServiceCard = lazy(() => import('@/components/services/NikeStyleServiceCard'));
const CustomCursor = lazy(() => import('@/components/interactions/CustomCursor'));
const ScrollReveal = lazy(() => import('@/components/gsap/ScrollReveal'));
...
export default function AwwwardsHomepage() {
  ...
  return (
    <>
      ...
      {/* Custom Cursor - Awwwards Signature */}
      ...
      >
        {/* Navigation - Tesla-style product-first */}
        <Suspense fallback={<div className="navigation-placeholder" />}>
          <TeslaStyleNavigation activeSection={activeSection} />
        </Suspense>
        
        {/* CINEMATIC VIDEO HERO - Awwwards SOTD Level */}
        <Suspense fallback={
          <div className="w-full h-screen bg-black flex items-center justify-center">
            <div className="text-text-secondary">Loading...</div>
          </div>
        }>
          <CinematicVideoHero prefersReducedMotion={prefersReducedMotion} />
        </Suspense>
        
        {/* INTERACTIVE GENERATOR CORE - WebGL Signature */}
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <div className="text-center mb-12">
                ...
                <p className="text-body-large text-text-secondary max-w-2xl mx-auto">
                  Experience our engineering excellence through an interactive 3D visualization
                  of our intelligent generator core technology.
                </p>
              </div>
            </ScrollReveal>
            <div className="h-[600px] rounded-2xl overflow-hidden border border-white/10">
              <GeneratorCore prefersReducedMotion={prefersReducedMotion} />
            </div>
          </div>
        </section>
        ...
        >
          <div className="hero-content">
            ...
            >
              ...
              >
                <span className="gradient-text text-body-large font-light">
                  Powering Kenya's Future Through Intelligent Energy Solutions
                </span>
                <span className="separator text-text-tertiary">|</span>
                <span className="text-body-large font-light text-text-secondary">Nairobi Engineered, Globally Trusted</span>
              </motion.div>
              {/* Enhanced emotional copywriting - Clear hierarchy */}
              <motion.p
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 1.5, duration: 0.8 }}
                className="text-body-large text-text-secondary max-w-4xl mx-auto mt-12 font-light leading-relaxed"
              >
        ...
        {/* Emotional Narrative - Nike-level storytelling with luxury spacing */}
        ...
        {/* IMMERSIVE POWER JOURNEY - Horizontal scroll narrative with generous spacing */}
        ...
        {/* SERVICES SHOWCASE - Nike-level sophisticated cards */}
        <Suspense fallback={<SectionSkeleton />}>
          <ServicesShowcase />
        </Suspense>
        
        {/* SERVICES TEASER - Legacy (keeping for compatibility) */}
        <section className="section-spacing-lg hidden">
          <ScrollReveal direction="up" delay={0.2}>
            <Suspense fallback={<SectionSkeleton />}>
              <ServicesTeaser 
                config={performanceConfig}
        ...
        {/* TECHNICAL SHOWCASE - Interactive schematics with luxury spacing */}
        <section className="section-spacing-lg">
        ...
        {/* CASE STUDIES - Award-winning projects with premium spacing */}
        <section className="section-spacing-xl">
