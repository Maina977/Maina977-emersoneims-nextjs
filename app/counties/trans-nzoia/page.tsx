/**
 * TRANS-NZOIA COUNTY PAGE
 * SEO-optimized page for Trans-Nzoia County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/trans-nzoia`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/trans-nzoia`
  },
  robots: {
    index: true,
    follow: true,
...
export default function TransNzoiaCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/trans-nzoia` }
      ]} />
