/**
 * ELGEYO-MARAKWET COUNTY PAGE
 * SEO-optimized page for Elgeyo-Marakwet County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/elgeyo-marakwet`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/elgeyo-marakwet`
  },
  robots: {
    index: true,
    follow: true,
...
export default function ElgeyoMarakwetCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/elgeyo-marakwet` }
      ]} />
