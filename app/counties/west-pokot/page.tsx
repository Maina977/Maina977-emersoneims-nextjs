/**
 * WEST-POKOT COUNTY PAGE
 * SEO-optimized page for West-Pokot County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/west-pokot`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/west-pokot`
  },
  robots: {
    index: true,
    follow: true,
...
export default function WestPokotCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/west-pokot` }
      ]} />
