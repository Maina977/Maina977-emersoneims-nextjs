/**
 * KAJIADO COUNTY PAGE
 * SEO-optimized page for Kajiado County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/kajiado`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/kajiado`
  },
  robots: {
    index: true,
    follow: true,
...
export default function KajiadoCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/kajiado` }
      ]} />
