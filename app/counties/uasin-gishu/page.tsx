/**
 * UASIN-GISHU COUNTY PAGE
 * SEO-optimized page for Uasin-Gishu County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/uasin-gishu`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/uasin-gishu`
  },
  robots: {
    index: true,
    follow: true,
...
export default function UasinGishuCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/uasin-gishu` }
      ]} />
