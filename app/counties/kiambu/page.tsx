/**
 * KIAMBU COUNTY PAGE
 * SEO-optimized page for Kiambu County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/kiambu`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/kiambu`
  },
  robots: {
    index: true,
    follow: true,
...
export default function KiambuCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/kiambu` }
      ]} />
