/**
 * NANDI COUNTY PAGE
 * SEO-optimized page for Nandi County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/nandi`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/nandi`
  },
  robots: {
    index: true,
    follow: true,
...
export default function NandiCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/nandi` }
      ]} />
