/**
 * LAIKIPIA COUNTY PAGE
 * SEO-optimized page for Laikipia County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/laikipia`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/laikipia`
  },
  robots: {
    index: true,
    follow: true,
...
export default function LaikipiaCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/laikipia` }
      ]} />
