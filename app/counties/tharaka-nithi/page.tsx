/**
 * THARAKA-NITHI COUNTY PAGE
 * SEO-optimized page for Tharaka-Nithi County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/tharaka-nithi`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/tharaka-nithi`
  },
  robots: {
    index: true,
    follow: true,
...
export default function TharakaNithiCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/tharaka-nithi` }
      ]} />
