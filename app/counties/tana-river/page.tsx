/**
 * TANA-RIVER COUNTY PAGE
 * SEO-optimized page for Tana-River County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/tana-river`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/tana-river`
  },
  robots: {
    index: true,
    follow: true,
...
export default function TanaRiverCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/tana-river` }
      ]} />
