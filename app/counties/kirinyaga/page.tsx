/**
 * KIRINYAGA COUNTY PAGE
 * SEO-optimized page for Kirinyaga County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/kirinyaga`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/kirinyaga`
  },
  robots: {
    index: true,
    follow: true,
...
export default function KirinyagaCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/kirinyaga` }
      ]} />
