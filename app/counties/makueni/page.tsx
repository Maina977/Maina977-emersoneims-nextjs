/**
 * MAKUENI COUNTY PAGE
 * SEO-optimized page for Makueni County
...
const COUNTY_DATA = {
  ...
  region: 'Eastern',
  population: 987653,
  constituencies: ['Makueni', 'Kilome', 'Kaiti', 'Kibwezi West', 'Kibwezi East', 'Mbooni']
};
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/makueni`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/makueni`
  },
  robots: {
    index: true,
    follow: true,
...
export default function MakueniCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/makueni` }
      ]} />
