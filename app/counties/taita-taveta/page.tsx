/**
 * TAITA-TAVETA COUNTY PAGE
 * SEO-optimized page for Taita-Taveta County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/taita-taveta`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/taita-taveta`
  },
  robots: {
    index: true,
    follow: true,
...
export default function TaitaTavetaCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/taita-taveta` }
      ]} />
