/**
 * MARSABIT COUNTY PAGE
 * SEO-optimized page for Marsabit County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/marsabit`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/marsabit`
  },
  robots: {
    index: true,
    follow: true,
...
export default function MarsabitCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/marsabit` }
      ]} />
