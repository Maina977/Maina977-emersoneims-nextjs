/**
 * HOMA-BAY COUNTY PAGE
 * SEO-optimized page for Homa-Bay County
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: `https://www.emersoneims.com/counties/homa-bay`,
    siteName: 'Emerson EiMS',
    locale: 'en_KE',
    type: 'website'
  },
  alternates: {
    canonical: `https://www.emersoneims.com/counties/homa-bay`
  },
  robots: {
    index: true,
    follow: true,
...
export default function HomaBayCountyPage() {
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: COUNTY_DATA.name, url: `https://www.emersoneims.com/counties/homa-bay` }
      ]} />
