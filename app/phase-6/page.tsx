...
export const metadata: Metadata = {
  /*
   * NOINDEX - an internal delivery-roadmap page, not a page for customers.
   *
  ...
  alternates: { canonical: 'https://www.emersoneims.com/phase-6' },
  title: 'Phase 6: Service Delivery Mastery',
