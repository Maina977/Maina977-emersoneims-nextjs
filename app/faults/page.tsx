        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
              Search over <span className="text-white font-semibold">3,800+ verified fault codes</span>, with range-based coverage of 450,000+ controller code numbers, from
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Search 3,800+ verified generator fault codes from Cummins, Perkins, DSE and ComAp, plus range-based coverage of 450,000+ controller code numbers. Get instant diagnosis and repair steps.",
            "provider": {
              "@type": "Organization",
              "name": "EmersonEIMS",
