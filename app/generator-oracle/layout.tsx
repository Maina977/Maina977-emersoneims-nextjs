...
export const metadata: Metadata = {
  ...
  description:
    'Generator Oracle is the EmersonEIMS generator fault & controller diagnostic intelligence tool. 3,800+ verified fault codes plus range-based coverage of 400,000+ controller code numbers, for DeepSea (DSE), ComAp, Woodward, SmartGen and CAT PowerWizard — with reset pathways and direct escalation to Kenya engineers. Free to use.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      '3,800+ verified fault codes, plus range-based coverage of 400,000+ controller code numbers, for DSE, ComAp, Woodward, SmartGen and PowerWizard. Built and maintained by Kenya generator engineers. Free to use.',
    url: URL,
    type: 'website',
    locale: 'en_KE',
  ...
  twitter: {
    ...
    description: '3,800+ verified codes + 400,000+ code-number coverage. Reset pathways. Engineer escalation. Free.',
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <FlagshipProductSchema
        ...
        url={URL}
        description="Generator fault & controller diagnostic intelligence: 3,800+ verified fault codes plus 400,000+ code-number coverage for DSE, ComAp, Woodward, SmartGen and PowerWizard, with reset pathways and Kenya engineer escalation."
