...
export const metadata: Metadata = {
  title: 'Generator Oracle Africa | 400,000+ Fault Codes for African Technicians',
  description: 'The #1 generator diagnostic tool for Africa. 400,000+ fault codes compatible with DSE, ComAp, Woodward, SmartGen, PowerWizard & more. Works offline. Available in Swahili, Arabic, French. Used by technicians in Kenya, Nigeria, Tanzania, Uganda, South Africa & 50+ countries.',
  keywords: [
  ...
  openGraph: {
    ...
    description: '400,000+ fault codes compatible with all major controller types. Works offline. Available in 7 languages including Swahili, Arabic & French. Trusted by technicians across Africa.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Generator Oracle Africa | 400,000+ Fault Codes',
...
const structuredData = {
  ...
  '@graph': [
    // Software Application
    {
      ...
      description: 'Professional generator diagnostic tool with 400,000+ fault codes compatible with DSE, ComAp, Woodward, SmartGen, PowerWizard and more controller types. Independently developed - not affiliated with any manufacturer.',
      offers: {
        '@type': 'Offer',
        price: '20000',
        priceCurrency: 'KES',
    ...
    // FAQPage
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Generator Oracle costs KES 20,000 per year (approximately $154 USD). This includes full access to 400,000+ fault codes, all languages, offline capability, and all updates. Free trial available until April 2026.',
          },
        },
        {
          '@type': 'Question',
