...
const STATISTICS = [
  { value: '400,000+', label: 'Fault Codes', icon: '🔍' },
...
const TESTIMONIALS = [
  ...
  {
    quote: "400,000+ fault codes in one app! I've used it for DSE, ComAp, and Woodward controllers - all accurate.",
    author: "Ahmed Hassan",
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            400,000+ fault codes, compatible with 9 controller types, 7 languages including Swahili, Arabic & French.
