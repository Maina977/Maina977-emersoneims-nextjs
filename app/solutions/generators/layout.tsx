...
export const metadata: Metadata = {
  title: "Generator Solutions Kenya | Installation, Repairs, Maintenance",
  ...
  openGraph: {
    title: "Generator Solutions Hub | Expert Installation & Repairs",
  ...
  twitter: {
    ...
    title: "Generator Solutions Kenya",
