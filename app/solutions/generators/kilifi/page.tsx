...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.emersoneims.com/solutions/generators/kilifi' },
  title: 'Generator Service in Kilifi',
  description: 'Backup power solutions in Kilifi. Installation, emergency repair, maintenance.',
};

export default function KilifiGeneratorPage() {
  return (
    <div className="min-h-screen bg-black text-white">
      <section className="py-20 px-4 bg-gradient-to-b from-slate-900 to-black">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-5xl font-bold mb-6">Generator Service in Kilifi</h1>
          <p className="text-xl text-gray-300">Professional backup power. 10-hour emergency response.</p>
        </div>
      </section>
