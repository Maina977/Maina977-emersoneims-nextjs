...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.emersoneims.com/solutions/generators/makueni' },
  title: 'Generator Service in Makueni',
  description: 'Backup power solutions in Makueni. Installation, emergency repair, maintenance.',
};
    ...
    <div className="min-h-screen bg-black text-white">
      <section className="py-20 px-4 bg-gradient-to-b from-slate-900 to-black">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-gray-300">Professional backup power. 12-hour emergency response.</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-cyan-500/20 rounded-lg">
              ...
              <p className="text-sm text-gray-300">KES 50K-200K. 12-hour response.</p>
            </div>
          </div>
          <div className="p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-cyan-500/20 rounded-lg">
