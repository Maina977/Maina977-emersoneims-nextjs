  ...
  return (
    <main className="bg-black min-h-screen">
      ...
      <section ref={heroRef} className="relative h-[90vh] min-h-[600px] overflow-hidden">
        ...
        >
          <Image
            src="/images/BAT 5.png"
            alt="UPS Battery Systems"
            fill
            priority
          ...
          {/* Teal/Purple Color Grade - Power & Energy Theme */}
          <div className="absolute inset-0 mix-blend-color" style={{ background: 'linear-gradient(135deg, rgba(30, 0, 80, 0.3) 0%, rgba(0, 150, 180, 0.2) 100%)' }} />
          ...
          <div className="absolute inset-0 mix-blend-multiply" style={{ background: 'linear-gradient(to bottom, rgba(10, 15, 47, 0.5) 0%, rgba(20, 10, 30, 0.4) 100%)' }} />

          {/* Cool Highlight Push - Electric Feel */}
          <div className="absolute inset-0 mix-blend-soft-light" style={{ background: 'radial-gradient(ellipse at 30% 20%, rgba(100, 150, 255, 0.3) 0%, transparent 60%)' }} />
        ...
        {/* Animated Electric Glow */}
        <motion.div
          className="absolute inset-0 pointer-events-none"
          initial={{ opacity: 0 }}
          animate={{ opacity: [0, 0.15, 0] }}
          transition={{ duration: 6, repeat: Infinity, repeatType: 'reverse' }}
          style={{ background: 'linear-gradient(45deg, transparent 40%, rgba(100, 100, 255, 0.15) 50%, transparent 60%)' }}
        />
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-white/90 tracking-wider uppercase">Power Protection Experts</span>
            </motion.div>
            ...
            >
              Complete guide to UPS installation, maintenance, and troubleshooting. Protect your critical equipment with expert knowledge.
            </motion.p>
            ...
            <motion.div
              ...
              className="mt-8 h-1 w-32 mx-auto bg-gradient-to-r from-transparent via-purple-500 to-transparent"
            />
          </motion.div>
        ...
        <div className="absolute top-1/4 left-0 right-0 h-px bg-gradient-to-r from-transparent via-purple-500/20 to-transparent blur-sm" />
      </section>
