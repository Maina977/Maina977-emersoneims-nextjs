...
export const controllerAlarmInterpretation: RepairArticle = {
  ...
  relatedSlugs: ['generator-cranks-but-will-not-start', 'generator-low-oil-pressure-shutdown', 'generator-starts-in-manual-not-auto', 'generator-starts-then-stops', 'j1939-spn-fmi-explained'],
