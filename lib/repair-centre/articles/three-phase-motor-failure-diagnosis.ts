...
export const threePhaseMotorFailureDiagnosis: RepairArticle = {
  ...
  relatedSlugs: ['borehole-pump-no-water-delivery', 'motor-overload-tripping', 'pcb-short-circuit-diagnosis', 'test-instruments-and-measurement-errors', 'vfd-drive-fault-diagnosis'],
