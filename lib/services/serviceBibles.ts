...
const MOTOR_BIBLE: ServiceBible = {
  ...
  installPhases: [
    ...
    { phase: '5. Reassemble', goal: 'Bearings and seals correct.', checklist: ['Genuine OEM bearings only', 'Grease per L10 calc', 'Balance rotor to ISO 21940-11 grade G2.5', 'Air-gap symmetry within 5%'] },
