...
export const FABRICATION_PARTS_CATALOGUE = {
  plasma: [
    { partNumber: 'PLASMA-ELEC-45', description: 'Electrode for 45A Plasma', brand: 'Hypertherm', priceKES: 1500, application: 'PowerMax 45', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-ELEC-65', description: 'Electrode for 65A Plasma', brand: 'Hypertherm', priceKES: 1800, application: 'PowerMax 65/85', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-NOZ-45', description: 'Nozzle for 45A Plasma', brand: 'Hypertherm', priceKES: 1200, application: 'PowerMax 45', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-NOZ-65', description: 'Nozzle for 65A Plasma', brand: 'Hypertherm', priceKES: 1500, application: 'PowerMax 65/85', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-SWIRL', description: 'Swirl Ring', brand: 'Hypertherm', priceKES: 2500, application: 'All PowerMax', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-SHIELD', description: 'Shield Cup', brand: 'Hypertherm', priceKES: 3500, application: 'All PowerMax', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-SET-45', description: 'Consumable Kit 45A', brand: 'Hypertherm', priceKES: 12000, application: '10-piece kit', suppliers: ['Welding supplies'] },
    { partNumber: 'PLASMA-SET-65', description: 'Consumable Kit 65A', brand: 'Hypertherm', priceKES: 15000, application: '10-piece kit', suppliers: ['Welding supplies'] },
  ],
  oxyFuel: [
    { partNumber: 'OXY-TIP-000', description: 'Cutting Tip Size 000', brand: 'Victor', priceKES: 2500, application: '1-3mm steel', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-TIP-0', description: 'Cutting Tip Size 0', brand: 'Victor', priceKES: 2500, application: '3-6mm steel', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-TIP-1', description: 'Cutting Tip Size 1', brand: 'Victor', priceKES: 2500, application: '6-12mm steel', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-TIP-2', description: 'Cutting Tip Size 2', brand: 'Victor', priceKES: 2500, application: '12-25mm steel', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-TIP-3', description: 'Cutting Tip Size 3', brand: 'Victor', priceKES: 2800, application: '25-50mm steel', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-REG-OXY', description: 'Oxygen Regulator', brand: 'Victor', priceKES: 12000, application: 'CGA 540', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-REG-ACET', description: 'Acetylene Regulator', brand: 'Victor', priceKES: 12000, application: 'CGA 510', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-HOSE-SET', description: 'Hose Set 15m', brand: 'Various', priceKES: 8500, application: 'Twin hose', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-FLASHBACK', description: 'Flashback Arrestor Set', brand: 'Various', priceKES: 5500, application: 'Torch end', suppliers: ['Welding supplies'] },
    { partNumber: 'OXY-STRIKER', description: 'Flint Striker', brand: 'Various', priceKES: 350, application: 'Ignition', suppliers: ['Welding supplies'] },
  ],
  sawBlades: [
    { partNumber: 'SAW-BAND-34', description: 'Bandsaw Blade 34x1.1mm', brand: 'Lenox', priceKES: 8500, application: 'General steel', suppliers: ['Tool suppliers'] },
    { partNumber: 'SAW-BAND-41', description: 'Bandsaw Blade 41x1.3mm', brand: 'Lenox', priceKES: 12500, application: 'Heavy duty', suppliers: ['Tool suppliers'] },
    { partNumber: 'SAW-COLD-250', description: 'Cold Saw Blade 250mm', brand: 'Various', priceKES: 25000, application: 'Steel cutting', suppliers: ['Tool suppliers'] },
    { partNumber: 'SAW-COLD-300', description: 'Cold Saw Blade 300mm', brand: 'Various', priceKES: 35000, application: 'Steel cutting', suppliers: ['Tool suppliers'] },
    { partNumber: 'SAW-CIRC-7', description: 'Circular Saw Blade 7" Metal', brand: 'DeWalt', priceKES: 3500, application: 'Steel cutting', suppliers: ['Hardware suppliers'] },
    { partNumber: 'SAW-CIRC-14', description: 'Circular Saw Blade 14" Metal', brand: 'DeWalt', priceKES: 8500, application: 'Chop saw', suppliers: ['Hardware suppliers'] },
  ],
  abrasives: [
    { partNumber: 'ABR-CUT-4.5', description: 'Cutting Disc 4.5" x 1mm', brand: 'Pferd', priceKES: 150, application: 'Angle grinder', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-CUT-9', description: 'Cutting Disc 9" x 2mm', brand: 'Pferd', priceKES: 350, application: 'Large grinder', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-GRIND-4.5', description: 'Grinding Disc 4.5" x 6mm', brand: 'Pferd', priceKES: 250, application: 'Metal grinding', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-FLAP-60', description: 'Flap Disc 4.5" 60 grit', brand: 'Pferd', priceKES: 450, application: 'Finishing', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-FLAP-80', description: 'Flap Disc 4.5" 80 grit', brand: 'Pferd', priceKES: 450, application: 'Finishing', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-WIRE-CUP', description: 'Wire Cup Brush', brand: 'Various', priceKES: 650, application: 'Cleaning', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-WIRE-WHEEL', description: 'Wire Wheel 4.5"', brand: 'Various', priceKES: 550, application: 'Cleaning', suppliers: ['Hardware suppliers'] },
    { partNumber: 'ABR-SAND-80', description: 'Sandpaper Roll 80 grit', brand: 'Various', priceKES: 2500, application: '50m roll', suppliers: ['Hardware suppliers'] },
  ],
  drillBits: [
    { partNumber: 'DRILL-HSS-SET', description: 'HSS Drill Bit Set 1-13mm', brand: 'Dormer', priceKES: 8500, application: 'General drilling', suppliers: ['Tool suppliers'] },
    { partNumber: 'DRILL-COBALT-SET', description: 'Cobalt Drill Set 1-10mm', brand: 'Dormer', priceKES: 15000, application: 'Stainless steel', suppliers: ['Tool suppliers'] },
    { partNumber: 'DRILL-ANNULAR-12', description: 'Annular Cutter 12mm', brand: 'Rotabroach', priceKES: 3500, application: 'Mag drill', suppliers: ['Tool suppliers'] },
    { partNumber: 'DRILL-ANNULAR-22', description: 'Annular Cutter 22mm', brand: 'Rotabroach', priceKES: 4500, application: 'Mag drill', suppliers: ['Tool suppliers'] },
    { partNumber: 'DRILL-HOLE-22', description: 'Hole Saw 22mm', brand: 'Various', priceKES: 850, application: 'Sheet metal', suppliers: ['Hardware suppliers'] },
    { partNumber: 'DRILL-HOLE-32', description: 'Hole Saw 32mm', brand: 'Various', priceKES: 1200, application: 'Sheet metal', suppliers: ['Hardware suppliers'] },
    { partNumber: 'DRILL-STEP', description: 'Step Drill 4-32mm', brand: 'Various', priceKES: 3500, application: 'Multiple sizes', suppliers: ['Tool suppliers'] },
    { partNumber: 'TAP-SET-METRIC', description: 'Metric Tap Set M3-M12', brand: 'Dormer', priceKES: 12500, application: 'Threading', suppliers: ['Tool suppliers'] },
  ],
  hydraulics: [
    { partNumber: 'HYD-OIL-20L', description: 'Hydraulic Oil ISO 46 20L', brand: 'Total', priceKES: 8500, application: 'General hydraulics', suppliers: ['Lubricant suppliers'] },
    { partNumber: 'HYD-FILTER-10', description: 'Hydraulic Filter Element', brand: 'Parker', priceKES: 5500, application: 'Return line', suppliers: ['Hydraulic suppliers'] },
    { partNumber: 'HYD-SEAL-KIT', description: 'Cylinder Seal Kit', brand: 'Various', priceKES: 3500, application: 'Per cylinder', suppliers: ['Hydraulic suppliers'] },
    { partNumber: 'HYD-HOSE-3/8', description: 'Hydraulic Hose 3/8" per meter', brand: 'Various', priceKES: 850, application: 'High pressure', suppliers: ['Hydraulic suppliers'] },
    { partNumber: 'HYD-HOSE-1/2', description: 'Hydraulic Hose 1/2" per meter', brand: 'Various', priceKES: 1200, application: 'High pressure', suppliers: ['Hydraulic suppliers'] },
    { partNumber: 'HYD-FITTING-KIT', description: 'Hydraulic Fitting Kit', brand: 'Various', priceKES: 8500, application: 'Common sizes', suppliers: ['Hydraulic suppliers'] },
  ],
  safety: [
    { partNumber: 'PPE-HELMET', description: 'Auto-darkening Helmet', brand: '3M', priceKES: 8500, application: 'Welding/cutting', suppliers: ['Safety suppliers'] },
    { partNumber: 'PPE-GOGGLES-SHADE5', description: 'Cutting Goggles Shade 5', brand: 'Various', priceKES: 850, application: 'Oxy-fuel', suppliers: ['Safety suppliers'] },
    { partNumber: 'PPE-GLOVES-WELD', description: 'Welding Gloves', brand: 'Various', priceKES: 1200, application: 'Heat protection', suppliers: ['Safety suppliers'] },
    { partNumber: 'PPE-APRON', description: 'Leather Apron', brand: 'Various', priceKES: 2500, application: 'Body protection', suppliers: ['Safety suppliers'] },
    { partNumber: 'PPE-BOOTS', description: 'Safety Boots Steel Toe', brand: 'Various', priceKES: 5500, application: 'Foot protection', suppliers: ['Safety suppliers'] },
    { partNumber: 'PPE-EARPLUGS', description: 'Ear Plugs (box 200)', brand: '3M', priceKES: 2500, application: 'Hearing', suppliers: ['Safety suppliers'] },
    { partNumber: 'PPE-RESPIRATOR', description: 'Half Face Respirator', brand: '3M', priceKES: 3500, application: 'Fumes', suppliers: ['Safety suppliers'] },
    { partNumber: 'FIRE-EXT-CO2', description: 'Fire Extinguisher CO2 5kg', brand: 'Various', priceKES: 12500, application: 'Electrical/metal fires', suppliers: ['Safety suppliers'] },
  ],
};
...
export const FABRICATION_KENYA_SUPPLIERS = [
  { name: 'Impala Welding Supplies', location: 'Nairobi Industrial Area', specialization: 'Welding and cutting equipment', phone: '+254 20 xxx xxxx', email: 'info@impalawelding.co.ke' },
  { name: 'Steel Structures Kenya', location: 'Nairobi', specialization: 'Fabrication machinery, steel', phone: '+254 20 xxx xxxx', email: 'sales@steelstructures.co.ke' },
  { name: 'Industrial Tools Kenya', location: 'Nairobi', specialization: 'Power tools, hand tools', phone: '+254 20 xxx xxxx', email: 'info@industrialtools.co.ke' },
  { name: 'Hydraulic Systems Ltd', location: 'Nairobi', specialization: 'Hydraulic equipment, repairs', phone: '+254 20 xxx xxxx', email: 'service@hydraulics.co.ke' },
  { name: 'BOC Kenya', location: 'Nationwide', specialization: 'Industrial gases', phone: '+254 20 xxx xxxx', email: 'kenya@boc.com' },
  { name: 'Safety First Kenya', location: 'Nairobi', specialization: 'PPE, safety equipment', phone: '+254 20 xxx xxxx', email: 'sales@safetyfirst.co.ke' },
];
