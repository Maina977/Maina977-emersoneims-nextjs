...
export const CUMMINS_BRAND_INFO = {
  ...
  benefits: [
    ...
    {
      title: '10-2000KVA Range',
      description: 'Complete power solutions from small business to industrial',
      icon: 'zap'
    },
    {
      title: 'Genuine Parts',
      description: '100% genuine Cummins spare parts with full traceability',
      icon: 'check'
    },
    {
      title: '24/7 Support',
  ...
  seoKeywords: [
    ...
    'Cummins 50KVA generator',
    'Cummins 100KVA generator',
    'Cummins 200KVA generator',
    'Cummins 500KVA generator',
    'Cummins 1000KVA generator',
    'Cummins 2000KVA generator',
    'buy Cummins generator Kenya',
    'Cummins generator dealer Nairobi',
  ...
  models: [
    ...
    { kva: 15, price: 'KES 450,000', application: 'Small Business' },
    { kva: 20, price: 'KES 550,000', application: 'Retail/Office' },
    { kva: 30, price: 'KES 750,000', application: 'Medium Business' },
    { kva: 50, price: 'KES 1,100,000', application: 'Large Office' },
    { kva: 60, price: 'KES 1,300,000', application: 'Small Factory' },
    { kva: 80, price: 'KES 1,600,000', application: 'Factory/Hotel' },
    { kva: 100, price: 'KES 2,000,000', application: 'Industrial' },
    { kva: 150, price: 'KES 2,800,000', application: 'Large Industrial' },
    { kva: 200, price: 'KES 3,500,000', application: 'Manufacturing' },
    { kva: 250, price: 'KES 4,200,000', application: 'Heavy Industry' },
    { kva: 300, price: 'KES 5,000,000', application: 'Large Factory' },
    { kva: 400, price: 'KES 6,500,000', application: 'Industrial Complex' },
    { kva: 500, price: 'KES 8,000,000', application: 'Power Plant' },
    { kva: 600, price: 'KES 10,000,000', application: 'Data Center' },
    { kva: 750, price: 'KES 12,500,000', application: 'Hospital/Mall' },
    { kva: 1000, price: 'KES 18,000,000', application: 'Major Industrial' },
    { kva: 1250, price: 'KES 22,000,000', application: 'Power Station' },
    { kva: 1500, price: 'KES 28,000,000', application: 'Grid Support' },
    { kva: 2000, price: 'KES 38,000,000', application: 'Utility Scale' },
  ],
  contact: {
...
export const CUMMINS_FAQ = [
  ...
  },
  {
    ...
    answer: "Yes, we provide complete turnkey installation including site preparation, electrical connections, ATS installation, commissioning, and operator training."
  },
  {
  ...
  },
  {
    ...
    answer: "We serve all industries including hospitals, hotels, manufacturing, agriculture, telecommunications, data centers, schools, shopping malls, and residential estates."
  },
  {
    question: "Do you offer financing for Cummins generators?",
    answer: "Yes, we work with leading banks and financial institutions to offer flexible payment plans and asset financing options for Cummins generator purchases."
  }
];

export default CUMMINS_BRAND_INFO;
