...
const markers = {
  'Upfront location panel': 'Set Site Location — Exact GPS',
  'Pinned confirmation': 'Drilling location PINNED',
  'Device GPS button': 'at the site',
  'Multi-upload button': 'select multiple',
  'Primary photo label': 'primary photo analyzed in full',
  'Drill point card': 'PRIMARY DRILLING POINT',
  'Google Maps link': 'google.com/maps?q=',
  'PDF ribbon': 'DRILL AT THE CROSSHAIR',
};
const found = {};
let jsCount = 0;
