...
const markers = {
  'B3 wells overlay': 'VERIFIED WELL',
  'B3 never-synthetic caption': 'never synthetic',
  'B7 drilling window': 'BEST DRILLING WINDOW',
  'B8 regression guard': 'Integrity Regression Guard',
  'B3 lat/lon on UNESCO wells': 'UNESCO IHP-WINS registry',
  'B1 decision brief': 'EXECUTIVE DECISION BRIEF',
  'B1 one-verdict box': 'FINAL VERDICT -- GOVERNS EVERY SECTION',
  'B1 next steps': 'UNLOCK BANKABLE GRADE',
